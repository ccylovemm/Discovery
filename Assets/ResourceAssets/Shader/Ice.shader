...
////// Lighting:
////// Emissive:
                float2 node_8005 = float2( _ScreenParams.z-1, _ScreenParams.w-1 );
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(node_8005.rg, _MainTex));
