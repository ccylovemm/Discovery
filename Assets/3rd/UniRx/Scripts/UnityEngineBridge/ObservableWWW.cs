...
namespace UniRx
{
    ...
    public static partial class ObservableWWW
    {
        ...
        public static IObservable<AssetBundle> LoadDownload(string url,  IProgress<float> progress = null)
        {
            return ObservableUnity.FromCoroutine<AssetBundle>((observer, cancellation) => FetchAssetBundle(new WWW(url), observer, progress, cancellation));
        }
