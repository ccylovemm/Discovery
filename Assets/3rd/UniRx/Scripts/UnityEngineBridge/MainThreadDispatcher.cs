...
namespace UniRx
{
    public sealed class MainThreadDispatcher : MonoBehaviour
    {
        ...
        new public static Coroutine StartAsCoroutine(IEnumerator routine)
        {
#if UNITY_EDITOR
        ...
        void Awake()
        {
            if (instance == null)
            {
                ...
                StartAsCoroutine(RunUpdateMicroCoroutine());
                StartAsCoroutine(RunFixedUpdateMicroCoroutine());
                StartAsCoroutine(RunEndOfFrameMicroCoroutine());
